...
const PreparingReading: React.FC<PreparingReadingProps> = ({ className = '' }) => {
  ...
  return (
    <Card className={`bg-black/30 border-amber-500/30 animate-pulse ${className}`}>
      <CardContent className="py-8 px-4 sm:px-6">
        {loading && !introMessage ? (
          <div className="flex flex-col items-center justify-center text-center space-y-4">
            ...
            <h3 className="text-xl font-bold text-amber-100">{t('tarot.invokingEnergies')}</h3>
          ...
          <div className="text-center space-y-4 animate-fade-in">
            ...
            <h3 className="text-xl font-bold text-amber-100">{t('tarot.cosmicMessageReceived')}</h3>
